...
import com.android.mediaplayer.utils.Sputils;
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (username.getText().toString().equals("") && password.getText().toString().equals("")) {
                    ...
                    String name=Sputils.getString("username");
                    String pwd=Sputils.getString("password");
                    if (name.equals(username.getText().toString())&&pwd.equals(password.getText().toString())) {
                        ...
                        LoginInfo loginInfo=new LoginInfo(1,null);
                        Intent intent=new Intent(LoginActivity.this,MainActivity.class);
                        intent.putExtra("logininfo",loginInfo);
                        startActivity(intent);
                        finish();
                            }else {
                        Toasty.success(LoginActivity.this, "用户或者密码错误！", Toasty.LENGTH_SHORT).show();
                    }
